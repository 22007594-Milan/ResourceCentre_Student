...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		assertEquals("Tesst that the Chromebook arraylist size is 1.", 1, chromebookList.size());
	...
	public void testRetrieveAllCamcorder() {
		...
		assertNotNull("Test if there is valid Camcoder arraylist to add to", camcorderList);
		assertEquals("Test that the Camcoder arraylist is empty.", 0, camcorderList.size());
